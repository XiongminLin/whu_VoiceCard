//// CDataGrid.cpp  : Definition of ActiveX Control wrapper class(es) created by Microsoft Visual C++
//
//
//#include "stdafx.h"
//#include "CDataGrid.h"
...
CString CDataGrid::GetItem(int ColNum)
{
	...
	CString aa=(CString)v_Value.bstrVal;
	return aa;
}
BEGIN_EVENTSINK_MAP(CDataGrid, CWnd)
